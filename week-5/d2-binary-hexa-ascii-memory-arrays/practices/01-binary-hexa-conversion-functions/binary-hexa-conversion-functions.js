...
// let blobSlice = blob.slice(2);
// return parseInt((blobSlice), 2)

blob = blob.substring(2); //takes off the first 2 indexes
blob = parseInt(blob, 2)  //,2 bc we are coming FROM base 2
//console.log({blob})
return blob
...
//return parseInt(blob) //creator of parseInt loved hexadecimal so no need for radix 16
